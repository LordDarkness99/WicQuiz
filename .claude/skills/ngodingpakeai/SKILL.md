...
- Workspace ID: `cb681c90-4f54-44ed-9955-2433814de428`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/cb681c90-4f54-44ed-9955-2433814de428.
...
2. `npx ngodingpakeai connect --workspace cb681c90-4f54-44ed-9955-2433814de428 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/cb681c90-4f54-44ed-9955-2433814de428. Only pass on links the CLI actually printed — never assemble one from an id yourself.
